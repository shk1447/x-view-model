...
var DevToolsHandler = /** @class */ (function () {
    ...
    // 컴포넌트 등록
    DevToolsHandler.prototype.registerComponent = function (context, componentName) {
        var _a;
...
var useViewModel = function (vm, keys, componentName) {
    if (!componentName) {
        componentName = react.useMemo(function () {
    ...
    return [
        state,
        vm.context.send.bind(Object.assign(vm.context, { _componentName: componentName })),
        vm.ref,
    ];
};
var useComputedViewModel = function (vm, selector, keys) {
    var compName = react.useMemo(function () {
        return getComponentName();
    }, []);
    var _a = useViewModel(vm, keys, compName), state = _a[0], send = _a[1], controller = _a[2];
...
var useMemoizedViewModel = function (vm, keys) {
    ...
    var _a = useViewModel(vm, keys, compName), fullState = _a[0], send = _a[1], ref = _a[2];
