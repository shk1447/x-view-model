...
var useViewModel = function (vm, keys, componentInfo) {
    if (componentInfo) {
        ...
        componentInfo = useMemo(function () {
...
var useComputedViewModel = function (vm, selector, keys) {
    var componentInfo = useMemo(function () {
        return getComponentInfo();
    }, []);
...
export { DevToolsHandler, devTools, registViewModel, useComputedViewModel, useMemoizedViewModel, useViewModel };
