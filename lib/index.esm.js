...
var useViewModel = function (vm, keys, componentName) {
    if (!componentName) {
        componentName = useMemo(function () {
...
export { PropertyHandler, devTools, registViewModel, useComputedViewModel, useMemoizedViewModel, useViewModel };
